    ...
    function gen_selector() {
        ...
        var s;
        var providers = [
            {longname: "myOpenID", shortname: "myOpenID", url_suffix: ".myopenid.com/", usercalled: "username", icon: "myopenid.ico", id: 8, website: "https://www.myopenid.com/", openid1: true, url_prefix: "http://", openid2: true},
            {longname: "Google", shortname: "Google", url_suffix: "", usercalled: "username", icon: "google.ico", id: 3, website: "https://www.google.com/accounts/o8/id", openid1: false, url_prefix: "https://www.google.com/accounts/o8/id", openid2: true},
            {longname: "Flickr", shortname: "Flickr", url_suffix: "", usercalled: "username", icon: "flickr.ico", id: 6, website: "http://www.flickr.com/", openid1: false, url_prefix: "http://www.flickr.com/photos/", openid2: true},
            {longname: "Yahoo!", shortname: "Yahoo!", url_suffix: "", usercalled: "yahoo id", icon: "yahoo.ico", id: 15, website: "http://yahoo.com/", openid1: true, url_prefix: "http://me.yahoo.com/", openid2: false},
            {longname: "America Online/AIM", shortname: "AOL", url_suffix: "", usercalled: "screenname", icon: "aol.ico", id: 1, website: "http://www.aol.com/", openid1: true, url_prefix: "http://openid.aol.com/", openid2: false},
            {longname: "Google Blogger", shortname: "Blogger", url_suffix: ".blogspot.com/", usercalled: "blog name", icon: "blogger.ico", id: 2, website: "http://www.blogger.com/", openid1: true, url_prefix: "http://", openid2: false},
            {longname: "Livejournal", shortname: "Livejournal", url_suffix: ".livejournal.com/", usercalled: "username", icon: "lj.ico", id: 7, website: "http://www.livejournal.com/", openid1: true, url_prefix: "http://", openid2: false},
            {longname: "Verisign PIP", shortname: "Verisign", url_suffix: ".pip.verisignlabs.com/", usercalled: "username", icon: "verisign.ico", id: 11, website: "http://pip.verisignlabs.com/", openid1: true, url_prefix: "http://", openid2: true},
            {longname: "Vidoop", shortname: "Vidoop", url_suffix: ".myvidoop.com/", usercalled: "username", icon: "vidoop.ico", id: 12, website: "http://www.vidoop.com/", openid1: true, url_prefix: "http://", openid2: true},
            {longname: "claimID", shortname: "claimID", url_suffix: "", usercalled: "username", icon: "claimid.ico", id: 4, website: "http://claimid.com/", openid1: true, url_prefix: "http://claimid.com/", openid2: false},
            {longname: "Technorati", shortname: "Technorati", url_suffix: "", usercalled: "username", icon: "technorati.ico", id: 10, website: "http://www.technorati.com/", openid1: true, url_prefix: "http://technorati.com/people/technorati/", openid2: false},
            {longname: "Vox", shortname: "Vox", url_suffix: ".vox.com/", usercalled: "username", icon: "vox.ico", id: 13, website: "http://www.vox.com/", openid1: true, url_prefix: "http://", openid2: false},
            {longname: "Wordpress", shortname: "Wordpress", url_suffix: ".wordpress.com/", usercalled: "username", icon: "wordpress.ico", id: 14, website: "http://www.wordpress.com/", openid1: true, url_prefix: "http://", openid2: false}];

        var oidTbId = "openid_identifier";
        ...
        var popup = new Element('iframe', {src: '/empty.html'});
        popup.id = "idselector";
        ...
        pdoc.open();
        pdoc.write('<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\" \"http://www.w3.org/TR/html4/strict.dtd\">' +
                   '<html>' +
                   '<head>' +
                   ...
                   'body {border:1px solid #083145;font:13px/1.231 arial,helvetica,clean,sans-serif;*font-size:small;*font:x-small;}' +
        ...
        s = header.style; s.fontWeight = "bold"; s.color = "#082F42"; s.backgroundColor = "#B8E6F9";
        ...
        function Cell(grid, idx) {
            ...
            var _this = this;
            td.onmouseover = function () { _this.onMouseOver(); };
            td.onmouseout = function () { _this.onMouseOut(); };
            td.onclick = function () { _this.onClick(); };

            var provider = providers[idx];
            var icon = pdoc.createElement("img");
            icon.src = provider ? ('/images/openid/' + provider.icon) : '/images/openid/openid.ico';
        ...
        var _ = Cell.prototype = {};
        _.onMouseOver = function () { if (!this.selected) { this.td.style.backgroundColor = "#cee1f8"; } };
        _.onMouseOut = function () { if (!this.selected) { this.td.style.backgroundColor = ""; } };
        _.onClick = function () {
            this.grid.select(this);
            var provider = providers[this.idx];
            if (this.idx == -1) {
                oidTb.value = 'http://';
                oidTb.focus();
            } else {
        ...
        _.setSelected = function (selected) {
            this.td.style.backgroundColor = selected ? "#aeccf1" : "";
        ...
        function Grid() {
            ...
            this.cells = [];
            for (var i = 0; i < providers.length; i++) { this.cells[i] = new Cell(this, i); }

            this.rows = [pdoc.createElement('tr'), pdoc.createElement('tr'), pdoc.createElement('tr'), pdoc.createElement('tr')];
        ...
        _.select = function (cell) {
            ...
            if (cell.idx > -1) {
                ...
                if (provider["openid2"] && !provider["openid1"]) {
                    ...
                    oidTb.value = provider.url_prefix + "username" + provider.url_suffix;
                ...
                nameLabel.style.visibility = 'hidden';
                nameTb.style.visibility = 'hidden';
                btnIcn.src = '/images/openid/openid.ico';
            }
        };
