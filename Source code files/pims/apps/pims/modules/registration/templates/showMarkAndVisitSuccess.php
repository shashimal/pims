<div id="tabs" class="div-tabs">
    <div >
        ...
        <ul>
            <li><a href="#tabs-1">Mark and Create Visit of Clinic</a></li>
        </ul>
		 <div class="message">
        ...
        <br />
       <form name="frmSearchBox" id="frmSearchBox" method="post" action="<?php echo url_for('registration/viewEpisodesOfPatient') ?>">
