<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">Occupational Categories Of STD Clinic Attendees</a></li>
        </ul>
        <br />
        <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewOccupationGraph') ?>/">
            <table width="487" >
                 <tr>
