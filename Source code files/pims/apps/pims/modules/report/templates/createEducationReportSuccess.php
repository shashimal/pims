<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">Education Report</a></li>
        </ul>
        <br />
       <form name="frmMarital" id="frmMarital" method="post" action="<?php echo url_for('report/viewEducationReport') ?>/">
            <table width="487" >
                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {                    
        ...
        $("#btnBack").click(function() {
            location.href = "<?php echo url_for('report/createEducationReport') ?>";
        });
