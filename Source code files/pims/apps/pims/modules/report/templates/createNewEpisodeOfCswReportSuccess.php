<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">New STD Episodes of CSW Report</a></li>
        </ul>
        <br />
       <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewNewEpisodesOfCswReport') ?>/">
            <table width="487" >
                <tr>
