<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">Marital Status Of STD Clinic Attendees</a></li>
        </ul>
        <br />
        <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewMaritalStatusGraph') ?>/">
            <table width="487" >
                <tr>
