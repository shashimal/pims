<div class="report-div">
    ...
    <hr class="report-hr" />
    <h4 align="center">STD Episodes of Foreigners - Quarter <?php echo $quarter . " in ". $year; ?></h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnExport-CSV").click(function() {
            location.href = "<?php echo url_for('report/exportStdEpisodeOfForeignersReport?cmbYear='.$year."&cmbQuarter=".$quarter."&rep=CSV") ?>";
        });
        
        $("#btnExport-PDF").click(function() {
            location.href = "<?php echo url_for('report/exportStdEpisodeOfForeignersReport?cmbYear='.$year."&cmbQuarter=".$quarter."&rep=PDF") ?>";
        });
