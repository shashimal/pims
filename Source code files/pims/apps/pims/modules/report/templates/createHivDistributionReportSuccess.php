<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">HIV Distribution Report</a></li>
        </ul>
        <br />
       <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewHivDistributionReport') ?>/">
            <table width="487" >
                <tr>
                    <td width="125">From<span class="required">*</span></td>
                    <td>
                   <?php 
						$currentYear = date("Y");				
					
					?>
					<select name="cmbFromYear" id ="cmbFromYear" >
					<?php 
						for($a=2000; $a <=2050; $a++) {
                ...
                <tr>
                   ...
                   <?php 
					...
					?>
					<select name="cmbToYear" id ="cmbToYear" >
					<?php 
						for($a=2000; $a <=2050; $a++) {
