<div id="tabs" class="div-tabs">
    <div >
        ...
        <form name="frmTracePatient" id="frmTracePatient" method="post" action="<?php echo url_for('report/viewDefaultPatientReport') ?>">
            <table width="487" >
                <tr>
...
<div id="divConfirmationDialog" title="Invalid Date">
   To date should be greater thant From date
</div> 
