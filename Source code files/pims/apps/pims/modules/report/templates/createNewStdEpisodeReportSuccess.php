<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">New STD Episode Report</a></li>
        </ul>
        <br />
       <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewNewStdEpisodeReport') ?>/">
            <table width="487" >
                <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#btnBack").click(function() {
            location.href = "<?php echo url_for(public_path('report/createNewStdEpisodeReport')) ?>";
        });
