<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">Reasons For Clinic Attendance Report </a></li>
        </ul>
        <br />
       <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewReasonForAttendanceReport') ?>/">
            <table width="487" >
                <tr>
