<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">STD Distribution</a></li>
        </ul>
        <br />
        <form name="frmAppoinment" id="frmAppoinment" method="post" action="<?php echo url_for('report/viewStdDistributionGraph') ?>/">
            <table width="487" >
                 <tr>
                ...
                <tr>
                  <td>Etiological Diagnosis</td>
                  <td><select id="etio" name="etio" tabindex="2" >
                <option value="1">Syphilis</option>
                <option value="2">Herpes</option>
                <option value="3">Gonorrhoea</option>
            </select></td>
                </tr>
                </table>
      </form>
