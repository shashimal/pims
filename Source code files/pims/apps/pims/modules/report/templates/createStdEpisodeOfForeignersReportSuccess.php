<div id="tabs" class="div-tabs">
    <div >
        <ul>
            <li><a href="#tabs-1">STD Episodes Of Foreigners</a></li>
        </ul>
        <br />
       <form name="frmMarital" id="frmMarital" method="post" action="<?php echo url_for('report/viewStdEpisodeOfForeignersReport') ?>/">
            <table width="487" >
                <tr>
